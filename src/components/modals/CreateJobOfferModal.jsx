...
export default function CreateJobOfferModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full max-w-3xl rounded-2xl sm:rounded-3xl p-6 sm:p-9 shadow-2xl border border-slate-100 relative my-6 animate-in fade-in zoom-in-95 duration-200"
