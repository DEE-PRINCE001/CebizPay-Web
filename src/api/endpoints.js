...
export const ENDPOINTS = {
    ...
    WALLET: {
      ...
      ORG_TRANSACTIONS_EXPORT: `${BASE_PREFIX}/org/wallet/transactions/export`,
    ...
    ORGANIZATION: {
      ...
      LOANS: {
        PLANS: `${BASE_PREFIX}/org/loan-plans`,
        PLAN_BY_ID: (id) => `${BASE_PREFIX}/org/loan-plans/${id}`,
        ...
        CONTRACTS: `${BASE_PREFIX}/org/loans/contracts`,
        CONTRACT_BY_ID: (id) => `${BASE_PREFIX}/org/loans/contracts/${id}`,
      },
    },
    ERP: {
      INVENTORY: {
    ...
    ADMIN: {
      ...
      INDIVIDUALS: {
        ...
        UPDATE_STATUS: (id) => `${BASE_PREFIX}/individuals/${id}/kyc-status`,
        UPDATE_KYC_STATUS: (id) => `${BASE_PREFIX}/individuals/${id}/kyc-status`,
        SUSPEND: (id) => `${BASE_PREFIX}/admin/individuals/${id}/suspend`,
        REACTIVATE: (id) => `${BASE_PREFIX}/admin/individuals/${id}/reactivate`,
